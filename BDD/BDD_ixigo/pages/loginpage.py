...
class LoginPage(BasePage):
    ...
    def login(self, mobile: str | None = None, timeout: int = 300):
        """Open login, optionally submit mobile, then wait for manual OTP."""
        dialog_opened = self.click_login()
        if dialog_opened and mobile:
